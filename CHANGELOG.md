...
- 7e60d83: Remove the Users, Domains, Groups, Clients, and Channels service modules, and rename Domain to Workspace and Client to Device throughout.
...
- f0c488e: Add the Rules Engine execution mode.
...
- f71ad27: fix report page metadata

## 0.18.5

### Patch Changes

- e0dfeb7: Add optional listRoles flag to report and rule view functions.
...
- 2f99f4b: add revoke and list refresh tokens
